...
import { allLeaguesData, useCurrentLeagueStore, useModalStore, useModalDropdownStore } from "@/states/StoreStates";
...
function CreateLeaugeModalContent() {
     ...
     async function createLeague() {
          ...
          if (response.error) {
               ...
               const response2 = await database.from("leagues").select("").eq('leagueID', response.data[0].leagueID);
