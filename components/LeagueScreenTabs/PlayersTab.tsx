                              ...
                              <View style={{ marginHorizontal: 16 }}>
                                   ...
                                   <View style={styles.playerImageContainer}>
                                        {item?.image_link?.substring(0, 2) === '//' ?
                                             <Image source={{ uri: `https:${item?.image_link}` }} style={styles.playerImage} /> :
                                             <Image source={require("@/assets/img/base/ph/sil.png")} style={styles.playerImage} />
                                        }
                                   </View>
                                   <LogoSVGComponent uri={`https://issac-eligulashvili.github.io/logo-images/${item?.team}.svg`}
                                        style={{
                                             height: 20,
                                             width: 20,
                                             position: "absolute",
                              ...
                              >
                                   <View>
                                        ...
                                        {item.player != "Empty" ?
                                             ...
                                             >
                                                  <Text style={[styles.playerInfoText, { color: colors[item?.position as keyof typeof colors] }]}>
                                                       {positionAbbriviations[item?.position as keyof typeof positionAbbriviations]?.toUpperCase()}{" "}
                                                  </Text>
